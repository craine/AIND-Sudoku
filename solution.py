...
def naked_twins(values):
    ...
    solve
    1. must see if two numbers are the same in a unit
    2. if true, pick first number in first square and solve
    3. if puzzle does not solve then try second number in first square, and so on
    """
